...
class CompletedOrdersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CompletedOrdersController>(
      init: CompletedOrdersController(),
      builder: (controller) {
  ...
  Widget _buildSearchBar(CompletedOrdersController controller) {
    return Row(
      children: [
        Expanded(
          child: TextField(
        ...
        const SizedBox(width: 12),
        IconButton(
          onPressed: () => controller.loadCompletedOrders(),
          icon: Container(
  ...
  Widget _buildOrdersList(CompletedOrdersController controller) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final packageStatus = order['packageStatus'] as String? ?? 'Tamamlandı';
